...
use move_core_types::{account_address::AccountAddress, annotated_extractor as AE};
use sui_types::SUI_SYSTEM_ADDRESS;
use sui_types::sui_system_state::VALIDATOR_MODULE_NAME;
use sui_types::sui_system_state::VALIDATOR_STRUCT_NAME;
use sui_types::{TypeTag, base_types::SuiAddress as NativeSuiAddress};

use crate::api::types::move_type::MoveType;
use crate::{
    api::{
        scalars::cursor::JsonCursor,
        types::{move_value::MoveValue, validator::Validator},
    },
    error::RpcError,
