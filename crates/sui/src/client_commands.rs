...
pub struct TestPublishArgs {
    ...
    pub publish_unpublished_dependencies: bool,
}
    ...
    pub async fn execute(
        ...
        let ret = match self {
            ...
            SuiClientCommands::TestPublish(args) => {
                ...
                if args.publish_unpublished_dependencies {
                    ...
                    for dep in root_package.sorted_packages().into_iter().rev() {
                        ...
                        // TODO: We need to differntiate between published (but in normal build env)
                        // and publishde ephemerally. We probably need helpers on the move package alt side.
                        // TODO: Skip system packages (intentionally)
                        ...
                        let publish_args = PublishArgs {
                            ...
                            skip_dependency_verification: args
                                .publish_args
